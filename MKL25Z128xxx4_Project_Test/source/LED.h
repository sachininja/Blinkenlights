...
/* Touch range of each color change according to the capacitive touch is defined here */
#define RED_TOUCH_RANGE_LOW 270u
#define RED_TOUCH_RANGE_HIGH 850u

#define GREEN_TOUCH_RANGE_LOW 850u
#define GREEN_TOUCH_RANGE_HIGH 1750u

#define BLUE_TOUCH_RANGE_LOW 1750u
